         ...
         forM_ [ "data/test/config_sixs_biggest.ini"
           ...
           cfg `shouldBe` (Right
                            BinocularsConfig {_binocularsDispatcherNcore = Nothing,
                                              ...
                                              _binocularsInputSdd = 1.1083 *~ meter,
                                              _binocularsInputDetrot = Just (1.5707963267948966 *~ radian),
                                              ...
                                              _binocularsInputA = Just (1.4452000000000001e-9 *~ meter),
                                              _binocularsInputB = Just (8.158e-10 *~ meter),
                                              _binocularsInputC = Just (1.2342000000000001e-9 *~ meter),
