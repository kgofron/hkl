         ...
         forM_ [ "data/test/config_sixs_biggest.ini"
           ...
           cfg `shouldBe` (Right
                            BinocularsConfig {_binocularsDispatcherNcore = Nothing,
                                              ...
                                              _binocularsInputAlpha = Just (Degree (1.5707963267948966 *~ radian)),
                                              _binocularsInputBeta = Just (Degree (1.5707963267948966 *~ radian)),
                                              _binocularsInputGamma = Just (Degree (1.5707963267948966 *~ radian)),
                                              _binocularsInputUx = Just (Degree ((-1.4169480479319254) *~ radian)),
                                              _binocularsInputUy = Just (Degree (0.9401030022569337 *~ radian)),
                                              _binocularsInputUz = Just (Degree ((-0.19054917649924238) *~ radian)),
